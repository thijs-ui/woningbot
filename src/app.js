...
(async () => {
  ...
  console.log('📌 Portals: Idealista (custom scraper) + ThinkSpain (custom scraper)');
  console.log('📌 Commands: /zoekwoning, /nieuwbouw');
  console.log('📌 Nieuwbouw: live scrape op aanvraag (geen dagelijkse sync)');
})();
